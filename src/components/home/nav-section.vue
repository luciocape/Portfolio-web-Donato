<template>
	...
	<nav class="navbar navbar-expand-sm mt-3 position-fixed top-0 p-3 rounded-5 item-blur" v-if="screenSize < 850">		
		<button class="navbar-toggler bg-light-subtle bg-opacity-10" type="button" data-bs-toggle="collapse" data-bs-target="#navbarsExample03"
			aria-controls="navbarsExample01" aria-expanded="false" aria-label="Toggle navigation">
			<span class="navbar-toggler-icon "></span>
		</button>
		<div class="collapse navbar-collapse" id="navbarsExample03">
			<ul class="navbar-nav d-flex justify-content-center align-items-center gap-4 m-0 m-auto">

				<li v-for="(item, index) in nav" :key="index" class="">
					<a :href="'#' + 'section' + index" class="d-flex flex-column-reverse align-items-start text-nowrap h5 m-0 text-secondary"><span
	...
	<!-- <nav class="navbar navbar-expand-sm mt-3 position-fixed top-0 start-0 w-100"
		v-if="screenSize < 850">
		<div class="d-flex justify-content-between align-items-center item-blur rounded-5 w-100 p-3">
			<button class="navbar-toggler ms-3" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavDropdown"
				aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
				<span class="navbar-toggler-icon"></span>
			</button>
			<div class="d-flex collapse navbar-collapse" id="navbarNavDropdown">
				<ul class="d-flex justify-content-around align-items-center m-0 ">
					<li v-for="(item, index) in nav" :key="index" class="nav-item">
						<a :href="'#' + 'section' + index" class="d-flex flex-column align-items-start nav-item">
							{{ item }}<span class="nav-line bg-tertiary me-2" :class="{ active: activeSection === index }"></span></a>
					</li>
				</ul>
			</div>
			<div class="d-flex me-3">
				<span class="moon text-light bg-opacity-10 bg-gradient rounded-circle" @click="colorMode">
					<svg v-show="mode === 'dark'" data-bs-theme-value="light" xmlns="http://www.w3.org/2000/svg"
						width="25" height="25" fill="currentColor" id="moon" class="bi bi-moon-stars-fill"
						viewBox="0 0 16 16">
						<path
							d="M6 .278a.77.77 0 0 1 .08.858 7.2 7.2 0 0 0-.878 3.46c0 4.021 3.278 7.277 7.318 7.277q.792-.001 1.533-.16a.79.79 0 0 1 .81.316.73.73 0 0 1-.031.893A8.35 8.35 0 0 1 8.344 16C3.734 16 0 12.286 0 7.71 0 4.266 2.114 1.312 5.124.06A.75.75 0 0 1 6 .278" />
						<path
					...
					<svg v-show="mode === 'light'" data-bs-theme-value="dark" xmlns="http://www.w3.org/2000/svg"
						width="25" height="25" fill="currentColor" id="sun" class="bi bi-brightness-high-fill"
						viewBox="0 0 16 16">
						<path
							d="M12 8a4 4 0 1 1-8 0 4 4 0 0 1 8 0M8 0a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 0m0 13a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 13m8-5a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1h2a.5.5 0 0 1 .5.5M3 8a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1h2A.5.5 0 0 1 3 8m10.657-5.657a.5.5 0 0 1 0 .707l-1.414 1.415a.5.5 0 1 1-.707-.708l1.414-1.414a.5.5 0 0 1 .707 0m-9.193 9.193a.5.5 0 0 1 0 .707L3.05 13.657a.5.5 0 0 1-.707-.707l1.414-1.414a.5.5 0 0 1 .707 0m9.193 2.121a.5.5 0 0 1-.707 0l-1.414-1.414a.5.5 0 0 1 .707-.707l1.414 1.414a.5.5 0 0 1 0 .707M4.464 4.465a.5.5 0 0 1-.707 0L2.343 3.05a.5.5 0 1 1 .707-.707l1.414 1.414a.5.5 0 0 1 0 .708" />
					</svg>
