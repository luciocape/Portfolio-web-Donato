		...
		<header class="position-sticky">
			...
			<section>
				...
				<div class="mt-3 mb-5 d-flex align-items-center gap-3">
					...
					<div class="moon text-light bg-opacity-10 bg-gradient rounded-circle" v-if="screenSize>=850" >
						<svg v-show="modeActive === 'light'" data-bs-theme-value="dark" xmlns="http://www.w3.org/2000/svg" width="25" height="25"
						...
						<svg v-show="modeActive === 'dark'" data-bs-theme-value="light" xmlns="http://www.w3.org/2000/svg" width="25" height="25"
